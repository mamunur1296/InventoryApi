...
namespace InventoryApi.Migrations
{
    ...
    [Migration("20240731074113_init1")]
    partial class init1
    {
            ...
            modelBuilder.Entity("InventoryApi.Entities.ActionRole", b =>
                {
                    ...
                    b.HasKey("ActionId", "MenuId", "RoleId", "SubMenuId");

                    b.HasIndex("MenuId", "RoleId");

                    b.HasIndex("SubMenuId", "RoleId");
            ...
            modelBuilder.Entity("InventoryApi.Entities.ActionRole", b =>
                {
                    ...
                    b.HasOne("InventoryApi.Entities.MenuRole", "MenuRole")
                        .WithMany("ActionRoles")
                        .HasForeignKey("MenuId", "RoleId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("InventoryApi.Entities.SubMenuRole", "SubMenuRole")
                        .WithMany("ActionRoles")
                        .HasForeignKey("SubMenuId", "RoleId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
