    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActionRoles", x => new { x.ActionId, x.MenuId, x.RoleId, x.SubMenuId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActionRoles_MenuRoles_MenuId_RoleId",
                        columns: x => new { x.MenuId, x.RoleId },
                        principalTable: "MenuRoles",
                        principalColumns: new[] { "MenuId", "RoleId" });
                    table.ForeignKey(
                        name: "FK_ActionRoles_SubMenuRoles_SubMenuId_RoleId",
                        columns: x => new { x.SubMenuId, x.RoleId },
                        principalTable: "SubMenuRoles",
                        principalColumns: new[] { "SubMenuId", "RoleId" });
                });

            migrationBuilder.CreateIndex(
                name: "IX_ActionRoles_MenuId_RoleId",
                table: "ActionRoles",
                columns: new[] { "MenuId", "RoleId" });

            migrationBuilder.CreateIndex(
                name: "IX_ActionRoles_SubMenuId_RoleId",
                table: "ActionRoles",
                columns: new[] { "SubMenuId", "RoleId" });
