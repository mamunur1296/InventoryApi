...
namespace InventoryApi.Controllers
{
    ...
    public class MenuController : ControllerBase
    {
        ...
        [HttpPut("Update/{id}")]
        public async Task<IActionResult> Update(string id, MenuDTOs model)
        {
        ...
        public async Task<IActionResult> getById(string id)
        {
            ...
            if (result != null)
            {
                return StatusCode((int)HttpStatusCode.OK, new ResponseDTOs<MenuDTOs>
                {
                    Success = true,
                    Data = result,
                    Status = HttpStatusCode.OK,
                    Detail = "Menu  get   successfully !!."
                });
            }
            return StatusCode((int)HttpStatusCode.BadRequest, result);
        }
