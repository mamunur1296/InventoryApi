...
namespace InventoryApi.Controllers
{
    ...
    public class PurchaseController : ControllerBase
    {
        ...
        public async Task<IActionResult> getAll()
        {
            ...
            if (result != null)
            {
                return StatusCode((int)HttpStatusCode.OK, new ResponseDTOs<IEnumerable<PurchaseDTOs>>
                {
                    Success = true,
                    Data = result,
                    Status = HttpStatusCode.OK,
                    Detail = "Purchase List   successfully !!."
                });
            }
            return StatusCode((int)HttpStatusCode.BadRequest, result);
        }
        ...
        public async Task<IActionResult> getById(string id)
        {
            ...
            if (result != null)
            {
                return StatusCode((int)HttpStatusCode.OK, new ResponseDTOs<PurchaseDTOs>
                {
                    Success = true,
                    Data = result,
                    Status = HttpStatusCode.OK,
                    Detail = "Purchase  get   successfully !!."
                });
            }
            return StatusCode((int)HttpStatusCode.BadRequest, result);
        }
        ...
        [HttpPut("Update/{id}")]
        public async Task<IActionResult> Update(string id, PurchaseDTOs model)
        {
