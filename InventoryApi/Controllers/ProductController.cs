...
namespace InventoryApi.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        [HttpPut("Update/{id}")]
        public async Task<IActionResult> Update(string id, ProductDTOs model)
        {
        ...
        public async Task<IActionResult> getById(string id)
        {
            ...
            if (result != null)
            {
                return StatusCode((int)HttpStatusCode.OK, new ResponseDTOs<ProductDTOs>
                {
                    Success = true,
                    Data = result,
                    Status = HttpStatusCode.OK,
                    Detail = "Product  get   successfully !!."
                });
            }
            return StatusCode((int)HttpStatusCode.BadRequest, result);
        }
