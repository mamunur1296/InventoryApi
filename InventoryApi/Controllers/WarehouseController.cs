...
namespace InventoryApi.Controllers
{
    ...
    public class WarehouseController : ControllerBase
    {
        ...
        [HttpPut("Update/{id}")]
        public async Task<IActionResult> Update(string id, WarehouseDTOs model)
        {
        ...
        public async Task<IActionResult> getById(string id)
        {
            ...
            if (result != null)
            {
                return StatusCode((int)HttpStatusCode.OK, new ResponseDTOs<WarehouseDTOs>
                {
                    Success = true,
                    Data = result,
                    Status = HttpStatusCode.OK,
                    Detail = "Warehouse  get   successfully !!."
                });
            }
            return StatusCode((int)HttpStatusCode.BadRequest, result);
        }
